...
\frame{
  ...
  \begin{center}
    ...
    \begin{columns}
      ...
      \item Resoluci\'on de una \'unica barra con resorte. Tama\~no de celda y selecci\'on de longitud de desarrollo

      \item An\'alisis de sensibilidad de malla para un caso de EC completo (mayor caudal)

      \item Resoluci\'on del problema final
      ...
      \begin{figure}
        \includegraphics[width=0.75\linewidth]{figsCAREM/malla/malla.png} %% \vspace{-3mm}
